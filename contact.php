...
<html>     
    <head>
        <meta charset="utf-8">
        <meta name="author" content="Vanessa Fernandez Diaz" />
    ...
    <body> <!--CET SITE WEB EST OPTIMISÉ POUR MIN 401px DANS GOOGLE CHROME-->
       <div id="retour" class="container container-globale">
             <?php include("menu.php"); ?>
        <main class="row">  <!-- commence le MAIN -->   
           <article class="contenu col-xs-12 col-xs-offset-2 col-md-6 col-md-offset-3">     <!-- Commence article CONTENU -->   
        ...
        </main> <!-- ici finit le MAIN -->        
        <script src="js/jquery-1.10.2.js"></script> 
        <script src="js/bootstrap.js"></script> <!-- script BOOTSTRAP COLLAPSE -->
